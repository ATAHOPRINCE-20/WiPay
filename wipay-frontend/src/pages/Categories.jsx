    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          <h2 className="text-lg font-bold text-gray-900 truncate">Categories</h2>
          <p className="text-xs sm:text-sm text-gray-400 truncate">Group packages by location or service type</p>
        </div>
